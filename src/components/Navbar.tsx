      ...
      <nav className="glass-nav border-b border-slate-200/80 shadow-sm transition-all relative">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20 gap-2 sm:gap-4">
            ...
            <div className="hidden xl:flex items-center gap-1.5 text-sm font-semibold text-slate-700">
              ...
              <Link 
                href="#gallery" 
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-bold text-slate-700 hover:text-amber-600 hover:bg-amber-50/60 transition-all"
              >
        ...
        {mobileMenuOpen && (
          <div className="xl:hidden bg-white/98 backdrop-blur-2xl border-b border-slate-200 px-4 pt-3 pb-6 space-y-3 shadow-2xl animate-ultimate-dropdown">
            ...
            {/* Quick Direct Mobile Links: Gallery & Location */}
            <div className="grid grid-cols-2 gap-2 pt-1">
              <Link
                href="#gallery"
                onClick={() => setMobileMenuOpen(false)}
                className="py-2.5 px-3 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-200/80 font-bold text-xs text-amber-950 flex items-center justify-center gap-1.5 transition-colors shadow-xs"
              >
              ...
              <Link
                href="#contact"
                onClick={() => setMobileMenuOpen(false)}
                className="py-2.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 font-bold text-xs text-slate-800 flex items-center justify-center gap-1.5 transition-colors"
              >
